namespace EasyMarkup.Core
{
    ...
    public class StringBuffer : Deque<char>, IComparable, IConvertible, IEquatable<StringBuffer>, IEquatable<string>, ICloneable
    {
        // Constructors
        ...
        public StringBuffer(IEnumerable<char> collection)
            : base(collection)
        {
        }

        public StringBuffer(string value)
            : base(value.ToCharArray())
        {
        }
        ...
        {
            return StartsWith(value.ToCharArray());
        }

        public bool StartsWithAny(params char[] values)
        {
            return !IsEmpty && values.Contains(PeekStart());
        }
        ...
        {
            return EndsWith(value.ToCharArray());
        }

        public bool EndsWithAny(params char[] values)
        {
            return !IsEmpty && values.Contains(PeekTail());
        }
        ...
        public void PushToStart(string value)
        {
            PushToStart(value.ToCharArray());
        }
