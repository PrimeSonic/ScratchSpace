namespace EasyMarkup
{
    ...
    public abstract class EmBase
    {
        ...
        {
            return ReadUntilDelimiter(fullString, SpChar_ValueDelimiter);
        }

        internal abstract EmBase Copy();

        internal abstract bool ValueEquals(EmBase other);

        internal bool Equals(EmBase other)
        {
            if (other is null)
            {
                return false;
            ...
            return this.Key == other.Key && ValueEquals(other);
        }
